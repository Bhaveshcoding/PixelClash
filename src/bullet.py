...
class Bullet:
    def __init__(self, start_pos: pygame.Vector2, direction_vec: pygame.Vector2, speed: float, lifetime: float, owner):
        self.pos = pygame.Vector2(start_pos.x, start_pos.y)
        self.velocity = direction_vec.normalize() * speed
        self.lifetime = lifetime
        self.size = BULLET_SIZE
        self.owner = owner  # Reference to the player entity who shot this
